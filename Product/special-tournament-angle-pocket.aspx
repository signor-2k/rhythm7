<%@ Page Title="Special Tournament Angle Pocket" Language="VB" MasterPageFile="~/Rhythm7.Master" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <h2 style="color: #fff">Special Tournament angle pocket</h2>

    <div style="width: 700px;">        
        <table style="width: 100%; color: #fff">
            <tr>
                <td style="vertical-align: top">
                    <img src="../Images/special_tournament_angle_pocket.jpg" style="width: 200px; height: 200px" />
                </td>
                <td style="vertical-align: top">
                    <table style="width: 100%;">
                        <tr>
                            <td style="vertical-align: top; font-size: 18px; color: #7ECA2B; font-weight: bold;">
                                Special features of <span style="text-decoration: underline">Special Tournament</span> angle pocket :-
                                <p></p>
                            </td>                        
                        </tr>                    
                        <tr>
