<%@ Page Title="Special Tournament Round Pocket" Language="VB" MasterPageFile="~/Rhythm7.Master" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <h2 style="color: #fff">Special Tournament round pocket</h2>

    <div style="width: 700px;"> 
        <table style="width: 100%; color: #fff">
            <tr>
                <td style="vertical-align: top">
                    <img src="../Images/special_tournament_round_pocket.png" style="width: 200px; height: 200px" />
                </td>
                <td style="vertical-align: top">
                    <table style="width: 100%;">
                        <tr>
                            <td style="vertical-align: top; font-size: 18px; color: #7ECA2B; font-weight: bold;">
                                Special features of <span style="text-decoration: underline">Special Tournament</span> round pocket :-
                                <p></p>
                            </td>                        
                        </tr>                    
                        <tr>
